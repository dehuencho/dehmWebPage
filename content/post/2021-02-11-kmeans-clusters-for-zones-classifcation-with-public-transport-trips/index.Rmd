...
```{r cluster_plot, out.extra='id="hoge"', fig.height=10, fig.width=7 ,warning=FALSE, message=FALSE}
set.seed(19634)
mod1 <- 
    kmeans(as.matrix(Kmeans_df %>%
                       select(-Zona)),
...
<ul class="nav nav-tabs">
  <li><a data-toggle="tab" href="#clst1">C01</a></li>
...
<div class="tab-content">
  <div id="clst1" class="tab-pane fade">
...
```
  ...
  <div id="clst3" class="tab-pane fade">
      <h3>Cluster 3</h3>
      <p>Some content in cluster 3.</p>
  </div>
  <div id="clst4" class="tab-pane fade">
      <h3>Cluster 4</h3>
      <p>Some content in cluster 4.</p>
  </div>
</div>